...
.. _file__home_ptsingaman_ros_ws_CoHAN2.0_src_hateb_local_planner_include_hateb_local_planner_footprint_model.h:

File footprint_model.h
======================
...
Definition (``/hateb_local_planner/include/hateb_local_planner/footprint_model.h``)
-----------------------------------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file__home_ptsingaman_ros_ws_CoHAN2.0_src_hateb_local_planner_include_hateb_local_planner_footprint_model.h.rst
...
- ``hateb_local_planner/pose_se2.h`` (:ref:`file__home_ptsingaman_ros_ws_CoHAN2.0_src_hateb_local_planner_include_hateb_local_planner_pose_se2.h`)
...
- :ref:`exhale_class_classPointShape`
